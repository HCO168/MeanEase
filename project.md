...
- `morphology*` 已完成结构切换；首轮自动安全候选 8,778 条加上 `spelling_mismatch_without_note` 人工复核新增 735 条，当前共 9,513 个词有学习型构词拆解，覆盖 47.57%；其余词保持空白等待后续复核或明确不可拆；
