#!/usr/bin/env python3
"""Prepare, validate, and merge legacy Chinese morphology review batches.
...
the entire selected batch has passed validation. It requires the historical
etymology* schema and must not be used to modify the current morphology* CSV.
"""
