...
当前已固化第 1–80 批、共 8,000 个词的人工审校记录。第 80 批含 95 条 `accepted` 说明和 5 条 `needs_review` 记录；非 `accepted` 记录不会发布词源文字，等待按义项继续人工复核。第 81 批及之后仍在逐词复核，未通过完整批次校验前不会写入本目录或正式词库。
